package nianhuibao.com.androidprojects.pull_recyclerView;
...
public class PullZoomView extends ScrollView {
    ...
    public PullZoomView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        sensitive = a.getFloat(R.styleable.PullZoomView_pzvSensitive, sensitive);
        isParallax = a.getBoolean(R.styleable.PullZoomView_pzvIsParallax, isParallax);
        isZoomEnable = a.getBoolean(R.styleable.PullZoomView_pzvIsZoomEnable, isZoomEnable);
        zoomTime = a.getInt(R.styleable.PullZoomView_pzvZoomTime, zoomTime);
        a.recycle();
