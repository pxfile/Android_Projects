...
import nianhuibao.com.androidprojects.property_animation.basic.PointAnimView;

/**
 * Created by rookie on 2016/8/9.
 */
public class ValueAnimationActivity extends Activity implements View.OnClickListener {
    PointAnimView view;
    //
