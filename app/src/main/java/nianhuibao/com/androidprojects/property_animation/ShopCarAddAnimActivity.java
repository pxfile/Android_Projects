...
import nianhuibao.com.androidprojects.property_animation.basic.GoodItem;
import nianhuibao.com.androidprojects.property_animation.basic.GoodsListAdapter;
import nianhuibao.com.androidprojects.property_animation.basic.GoodsListAdapter1;
import nianhuibao.com.androidprojects.utils.DisplayUtils;

/**
 * Created by rookie on 2016/10/24.
 */

public class ShopCarAddAnimActivity extends Activity implements
    ...
    private void addToCarAnimation(ImageView goodsImg) {
        ...
        float startX = animImgLocation[0] - shellLocation[0] + goodsImg.getWidth() / 2 - DisplayUtils.dipToPx(10.0f);
        float startY = animImgLocation[1] - shellLocation[1] + goodsImg.getHeight() / 2 - DisplayUtils.dipToPx(10.0f);
