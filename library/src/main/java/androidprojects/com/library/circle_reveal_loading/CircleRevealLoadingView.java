package androidprojects.com.library.circle_reveal_loading;
...
public class CircleRevealLoadingView extends View {
    ...
    public CircleRevealLoadingView(Context context) {
        this(context, null);
    }

    public CircleRevealLoadingView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleRevealLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context, attrs);
    }

    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CircleRevealLoadingView);
        mStartColor = typedArray.getColor(R.styleable.CircleRevealLoadingView_circleStartColor,
                ContextCompat.getColor(context, R.color.colorPrimary));
        mEndColor = typedArray.getColor(R.styleable.CircleRevealLoadingView_circleEndColor,
                ContextCompat.getColor(context, R.color.colorPrimaryDark));
        mArcSpacing = typedArray.getInteger(R.styleable.CircleRevealLoadingView_circleArcSpacing, 10);
        mArcWidth = typedArray.getInteger(R.styleable.CircleRevealLoadingView_circleArcWidth, 5);
        mArcRadian = typedArray.getInteger(R.styleable.CircleRevealLoadingView_circleArcWidth, 5);
        typedArray.recycle();
